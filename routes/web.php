...
//    });
    ...
    Route::group(['prefix'=> 'habitos', 'where'=>['id'=>'[0-9]+']], function(){
        ...
        Route::get('habitos/{id}/edit',     ['as'=>'habitos.edit',    'uses'=>'HabitosController@edit']);
        Route::put('habitos/{id}/update',   ['as'=>'habitos.update',  'uses'=>'HabitosController@update']);
        Route::post('habitos/store',        ['as'=>'habitos.store',   'uses'=>'HabitosController@store']);
    ...
    Route::group(['prefix'=> 'historicos', 'where'=>['id'=>'[0-9]+']], function(){
        ...
        Route::post('historicos/store',         ['as'=>'historicos.store',   'uses'=>'HistoricosController@store']);
